/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/pdf-consumer/wrangler.jsonc --env-interface=PdfConsumerEnv workers/pdf-consumer/worker-configuration.d.ts` (hash: 4cc8478ea6f242245710ba2b4df95964)
// Runtime types generated with workerd@1.20260911.1 2026-05-08 
interface __BaseEnv_PdfConsumerEnv {
	PDF_BUCKET: R2Bucket;
}
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_PdfConsumerEnv {}
}
interface PdfConsumerEnv extends __BaseEnv_PdfConsumerEnv {}
